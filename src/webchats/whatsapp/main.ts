...
runtime.onMessageAddListener((request, sender) => {
  ...
  switch (message) {
    ...
    case Settings.MESSAGE_WEBCHAT_BLUR_ENABLE:
      utils.readSettings(Settings.CONFIG_WEBCHAT_BLUR_DISABLE);
      break;
    case Settings.MESSAGE_WEBWHATSAPP_BLUR_DISABLE:
    case Settings.MESSAGE_WEBWHATSAPP_BLUR_ENABLE:
      utils.readSettings(Settings.CONFIG_WEBWHATSAPP_BLUR_DISABLE);
      break;
    default:
      break;
  }
